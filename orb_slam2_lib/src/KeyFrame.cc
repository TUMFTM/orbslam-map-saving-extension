...
void KeyFrame::serialize(Archive &ar, const unsigned int version)
{
    ...
    //lock the mutex just to access protected vars (save them in Archive ar) and release it when exiting the block
    {
    ...
    // BoW
    ar & mpKeyFrameDB;
    // mpORBvocabulary is restored using the SetORBvocab function
    {
        // Grid related
