...
Viewer::Viewer(IFrameRenderer *pFrameRenderer, MapDrawer *pMapDrawer, Tracking *pTracking, const std::string &strSettingPath, bool mbReuseMap_)
    : mpFrameRenderer(pFrameRenderer), mpMapDrawer(pMapDrawer), mpTracker(pTracking), mbReuseMap(mbReuseMap_)
{
...
void Viewer::Run()
{
    ...
    //Set Viewer field Localization mode as pressed if mbReuseMap is True
